...
class _CheckAttendanceState extends State<CheckAttendance> {
  ...
  Widget build(BuildContext context) {
    return Consumer2<AttendanceProvider,LocationProvider>(
      ...
      return attProvider.attCheck==false?const Loading():Column(
        ...
        Row(
          ...
          children: [
            ...
            if(attProvider.mainCheckOut == false)
              ...
              //   children: [
              //     CustomCheckBox(
              //         text: "Verify", onChanged: (value){
              //       attProvider.manageSelfie();
              //     },
              //         saveValue: attProvider.isSelfie),
              //     CustomCheckBox(
              //         text: "Permission", onChanged: (value){
              //       // if(attProvider.mainAttendance==0){
              //       //   utils.showWarningToast(context, text: "Please check in before applying for permission.");
              //       // }else
              //
              //     },
              //         saveValue: attProvider.isPermission),
              //   ],
              // ),
            // if(split.last!="1"&&attProvider.mainAttendance!=0)
