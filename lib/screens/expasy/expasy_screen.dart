...
class ExpasyScreen extends StatefulWidget {
  const ExpasyScreen({super.key});

  @override
  State<ExpasyScreen> createState() => _ExpasyScreenState();
}

class _ExpasyScreenState extends State<ExpasyScreen> with SingleTickerProviderStateMixin{
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      expenseProvider.tabController = TabController(length: 2, vsync: this);
    });
  }
    ...
    builder: (context, expenseProvider, _) {
      ...
      return Scaffold(
        appBar: PreferredSize(
          ...
          child: CustomAppbar(text: constValue.allExp),
        ),
        floatingActionButton: FloatingActionButton(
          onPressed: (){
            if(expenseProvider.tabController?.index==0){
              showDialog(
                context: context,
          ...
          },backgroundColor: colorsConst.primary,child: Icon(Icons.add),),
                  ...
                  children: [
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: customDecoration.baseBackgroundDecoration(
                                  color: Colors.white,borderColor: Colors.grey.shade100,radius: 12
                                ),
                                child: InkWell(
                                  onTap: () =>
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              CustomText(text: "Main Balance",colors: Colors.green,),10.width,
                              CustomText(text: expenseProvider.formattedAmount(expenseProvider.mainBalance-expenseProvider.totalExpenses<0?0
                                  :expenseProvider.mainBalance-expenseProvider.totalExpenses),colors: Colors.green,isBold: true,size: 16,)
                            ],
                          ),5.height,
                          Row(
                            children: [
                    ...
                    DefaultTabController(
                      ...
                      child: Column(children: [
                        TabBar(
                          controller: expenseProvider.tabController,
