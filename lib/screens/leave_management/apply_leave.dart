...
import '../../model/leave/leave_model.dart'; // ✅ NEW - needed for editData type
...
class ApplyLeave extends StatefulWidget {
  final String? date1;
  final String? date2;
  final LeaveModel? editData; // ✅ NEW - null = create mode, not-null = edit mode
...
class _ApplyLeaveState extends State<ApplyLeave> {
  ...
  bool get isEditMode => widget.editData != null; // ✅ NEW helper
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      if (isEditMode) {
        // ✅ EDIT MODE - prefill form with existing leave data
            ...
            child: SafeArea(
              child: Scaffold(
                ...
                appBar: PreferredSize(
                  ...
                  child: CustomAppbar(
                    text: isEditMode ? "Edit Leave" : "Leave Application", // ✅ dynamic title
                    callback: () {
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          CustomText(
                                            text:
                                            "${levProvider.stDate} ${levProvider.stDate != levProvider.enDate && levProvider.enDate != "" ? " To ${levProvider.enDate}" : ""}",
                                          ),
                                        ],
                                      ),
                                    )),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                CustomLoadingButton(
                                    ...
                                    if (levProvider.dayType == null) {
                                      ...
                                      if (localData.storage.read("role") == "1") {
                                        if (levProvider.name == null) {
                                          ...
                                          _myFocusScopeNode.unfocus();
                                          if (isEditMode) {
                                            // ✅ EDIT MODE - update existing leave
                                  ...
                                  text: isEditMode ? 'Update' : 'Apply', // ✅ dynamic button text
