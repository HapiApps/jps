...
class UserTaskExpense extends StatefulWidget {
  final String id;
  final String date1;
  final String date2;
  final String name;
  const UserTaskExpense({super.key, required this.id, required this.date1, required this.date2, required this.name});

  @override
  State<UserTaskExpense> createState() => _UserTaskExpenseState();
}

class _UserTaskExpenseState extends State<UserTaskExpense> with SingleTickerProviderStateMixin {
  @override
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<ExpenseProvider>(context, listen: false).getUserTaskExpense(widget.id,widget.date1,widget.date2);
    });
    super.initState();
  }
