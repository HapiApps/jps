...
class UserTaskAttendance extends StatefulWidget {
  final String id;
  final String date1;
  final String date2;
  final String name;
  const UserTaskAttendance({super.key, required this.id, required this.date1, required this.date2, required this.name});

  @override
  State<UserTaskAttendance> createState() => _UserTaskAttendanceState();
}

class _UserTaskAttendanceState extends State<UserTaskAttendance> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<TaskProvider>(context, listen: false).getUserTaskAttendance(widget.id,widget.date1,widget.date2);
    });
    super.initState();
  }
  @override
                              ...
                              Container(
                                 ...
                                 child: Padding(
                                   ...
                                   child: Column(
                                     ...
                                     children: [
                                       Center(child: CustomText(text: taskProvider.crtDate(data.checkInTs.toString(), "1"),isBold: true)),
                                       Row(
