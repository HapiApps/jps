...
//
//
// class TaskAddVisit extends StatefulWidget {
...
//   final bool isDirect;
//   const TaskAddVisit({super.key, required this.companyId, required this.companyName, required this.numberList, required this.isDirect, required this.taskId, required this.type, required this.desc});
//
//   @override
//   State<TaskAddVisit> createState() => _TaskAddVisitState();
// }
//
// class _TaskAddVisitState extends State<TaskAddVisit> with TickerProviderStateMixin {
