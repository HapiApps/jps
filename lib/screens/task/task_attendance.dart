...
class TaskAttendance extends StatefulWidget {
  final String taskId;
  final List<CustomerAttendanceModel>  customerAttendanceReport;
  const TaskAttendance({super.key, required this.taskId, required this.customerAttendanceReport});

  @override
  State<TaskAttendance> createState() => _TaskAttendanceState();
}

class _TaskAttendanceState extends State<TaskAttendance> {
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            widget.customerAttendanceReport.isEmpty?
            const Center(child: CustomText(text: "\n\n\n\nNo Visit Found"))
                :Expanded(
              child: ListView.builder(
                  itemCount: widget.customerAttendanceReport.length,
                  itemBuilder: (context,index){
                    CustomerAttendanceModel data = widget.customerAttendanceReport[index];
                    ...
                    return Column(
                      children: [
                       ...
                       Container(
                               ...
                               children: [
                                 ...
                                 Row(
                                   ...
                                   children: [
                                     Row(
                                       children: [
                                         CustomText(text: data.firstname.toString(),colors: colorsConst.primary,isBold: true,),5.width,
                                         CustomText(text: data.role.toString(),colors: colorsConst.greyClr,),
                                       ],
                                     ),
                                 ...
                                 Column(
                                   ...
                                   children: [
                                     if(localData.storage.read("role")!='1')
                                     Row(
                                     mainAxisAlignment: localData.storage.read("role")!='1'?MainAxisAlignment.spaceBetween:MainAxisAlignment.center,
                                     children: [
                                       CustomText(text: taskProvider.crtDate(data.checkInTs.toString(), "1"),colors: colorsConst.orange,),
                                       InkWell(
                                         onTap:(){
                                           utils.navigatePage(context, ()=>CheckLocation(
                                             addressShow: true,
                                       ...
                                       children: [
                                         Row(
                                           children: [
                                             SizedBox(
                                                 // color:Colors.yellow,
                                                 width: kIsWeb?webWidth/7:phoneWidth/7,
                        ...
                        index==widget.customerAttendanceReport.length-1?80.height:10.height
                      ],
                    );
                  }),
            ),
