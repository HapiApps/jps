...
class CustomerTasks extends StatefulWidget {
  ...
  final String date2;
  final String name;
  const CustomerTasks({super.key, required this.date1, required this.date2, required this.name, required this.id});
...
class _CustomerTasksState extends State<CustomerTasks>{
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      taskProvider.getCustomerTasks(widget.id,widget.date1,widget.date2);
    });
  }
